            ...
            <div class="left_column">
                ...
                <div class="row  content-center">
                    <q-avatar size="40mm" style="margin:1.5mm auto 1.5mm auto;">
                        <q-img style="height: 50mm; width: 50mm; margin-top:-5mm;" src="https://casillas.dev/api/storage/uploads/2021/10/25/profile_circle_uid_61770d9fe51de.png"
                        />
                    </q-avatar>
                </div>
        ...
        data: () => ({
            ...
            cv_data :{
                ...
                expertise:[
                    ...
                    {name: "IT proj. architecture design", level: 4},
                    {name: "IT proj. management", level: 4},
                    {name: "Data architecture, storage, access", level: 4},
                ],

                competences:[
                    {name: "3D tools: Unity/Blender", level: 4},
                    {name: "2D: PS/Inskape/Gimp", level: 4},

                    {name: "MySQL/MariaDB/Galera", level: 4},
                    {name: "Java Spring", level: 3},
                    {name: "Front End [Angular - Vue]", level: 4},

                    {name: "Django", level: 4},
                    {name: "Laravel", level: 3},

                    {name: "CMS: Wordpress, Cockpit", level: 4},
                    {name: "Git/SVN/SSH", level: 4},
                ],
